...
mixin _$InventoryItemModel {
  ...
  String get unit => throw _privateConstructorUsedError; // kg, pieces, etc.
  String get category =>
      throw _privateConstructorUsedError; // Decoration, Food, etc.
  InventoryStatus get status => throw _privateConstructorUsedError;
  double? get estimatedCost => throw _privateConstructorUsedError;
  String? get responsibleRole => throw _privateConstructorUsedError;
...
class _$InventoryItemModelCopyWithImpl<$Res, $Val extends InventoryItemModel>
  ...
  $Res call({
    ...
    Object? responsibleRole = freezed,
    Object? note = freezed,
  }) {
    return _then(
      _value.copyWith(
            ...
            estimatedCost: freezed == estimatedCost
                ...
                : estimatedCost // ignore: cast_nullable_to_non_nullable
                      as double?,
            responsibleRole: freezed == responsibleRole
                ? _value.responsibleRole
                : responsibleRole // ignore: cast_nullable_to_non_nullable
                      as String?,
            note: freezed == note
                ? _value.note
...
class _$InventoryItemModelImpl implements _InventoryItemModel {
  const _$InventoryItemModelImpl({
    ...
    this.status = InventoryStatus.needed,
    this.estimatedCost,
  ...
  @override
  String toString() {
    return 'InventoryItemModel(id: $id, eventId: $eventId, name: $name, quantity: $quantity, unit: $unit, category: $category, status: $status, estimatedCost: $estimatedCost, responsibleRole: $responsibleRole, note: $note)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.responsibleRole, responsibleRole) ||
                other.responsibleRole == responsibleRole) &&
...
abstract class _InventoryItemModel implements InventoryItemModel {
  ...
  double get quantity;
  @override
  String get unit; // kg, pieces, etc.
  @override
  String get category; // Decoration, Food, etc.
  @override
  InventoryStatus get status;
  @override
  double? get estimatedCost;
  @override
  String? get responsibleRole;
  @override
  String? get note;
